...
/**
 * \file    test/functional/UwSyncNumRefFacturesFunctionalTest.php
...
/**
 * Class UwSyncNumRefFacturesFunctionalTest
 *
 ...
 *
 * @package Testuwsyncnumreffactures
 */
class UwSyncNumRefFacturesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modUwSyncNumRefFactures')->click();
		} else {
			// Disable the module
			$this->byHref('modUwSyncNumRefFactures')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/uwsyncnumreffactures/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('uwsyncnumreffactures/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/uwsyncnumreffactures/admin/about.php');
		$this->authenticate();
		return $this->assertContains('uwsyncnumreffactures/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('uwsyncnumreffactureswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modUwSyncNumRefFactures_UwSyncNumRefFacturesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modUwSyncNumRefFactures_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
